//
//  SelectExerciseForMetconViewController.swift
//  WorkoutTracker
//
...
class SelectExerciseForMetconViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBAction func addExercise(_ sender: UIButton) {
        ...
        if exercises.count == 0{
            ...
            let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "metconVC") as! MetconViewController
